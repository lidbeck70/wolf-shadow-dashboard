...
NORDIC_MIDSMALL_SE: dict = {
    ...
    "LUND-B.ST": {"name": "Lundbergföretagen B", "country": "Sweden", "sector": "Financials"},
    "LUMI.ST":   {"name": "Lundin Mining", "country": "Sweden", "sector": "Materials"},
    "LOOMIS.ST": {"name": "Loomis", "country": "Sweden", "sector": "Industrials"},
