...
def render_rules_page() -> None:
    ...
    guide_data = [
        ...
        ("WOLF REGIME", "Wolf #1-11 (alla)",
         "4-lagers regime + Entry Checklist (Trend/Volatilitet/Momentum/Candlestick/OB). Alla 11 gates med auto-pass/fail."),
        ("ALPHA REGIME", "Alpha #1-7",
         "Alla 10 regler som live gates. GRÖN/ORANGE/RÖD badge. X/10 gates passed. EMA-nivåer + F&G + drawdown."),
        ("VIKING REGIME", "Alpha #1-5 | Viking alla",
